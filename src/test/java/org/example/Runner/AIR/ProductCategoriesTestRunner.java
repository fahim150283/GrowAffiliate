...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-reports-html/ProductCategories.html",
                "json:target/cucumber-reports/ProductCategories.json"},
        features = {"src/test/resources/Features/AIR/ProductCategories.feature"},
        publish = true,
...
public class ProductCategoriesTestRunner extends AbstractTestNGCucumberTests {
}
